...
__attribute__((unused)) static void ASIQPreviousNextViewImpl_nativeRemoveViewWithASIWidget_(ASIQPreviousNextViewImpl *self, id<ASIWidget> widget);
...
@interface ASIQPreviousNextViewImpl_IQPreviousNextViewExt () {
 @public
  WEAK_ ASIQPreviousNextViewImpl *this$0_;
...
J2OBJC_EMPTY_STATIC_INIT(ASIQPreviousNextViewImpl_$Lambda$1)

__attribute__((unused)) static void ASIQPreviousNextViewImpl_$Lambda$1_initWithASIWidget_(ASIQPreviousNextViewImpl_$Lambda$1 *self, id<ASIWidget> capture$0);

__attribute__((unused)) static ASIQPreviousNextViewImpl_$Lambda$1 *new_ASIQPreviousNextViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ASIQPreviousNextViewImpl_$Lambda$1 *create_ASIQPreviousNextViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0);
...
- (id<ASIWidget>)newInstance {
  return new_ASIQPreviousNextViewImpl_initWithNSString_withNSString_(groupName_, localName_);
}
...
- (bool)removeWithASIWidget:(id<ASIWidget>)w {
  ...
  ASIQPreviousNextViewImpl_nativeRemoveViewWithASIWidget_(self, w);
  return remove;
}
...
- (bool)removeWithInt:(int32_t)index {
  ...
  if (index + 1 <= [((ADFrameLayout *) nil_chk(frameLayout_)) getChildCount]) {
    ...
    ASIQPreviousNextViewImpl_nativeRemoveViewWithASIWidget_(self, widget);
  }
  return remove;
}
...
- (IOSClass *)getViewClass {
  return ASIQPreviousNextViewImpl_IQPreviousNextViewExt_class_();
}
...
void ASIQPreviousNextViewImpl_nativeRemoveViewWithASIWidget_(ASIQPreviousNextViewImpl *self, id<ASIWidget> widget) {
  ...
  if (layoutTransition != nil && ([layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_CHANGE_DISAPPEARING] || [layoutTransition isTransitionTypeEnabledWithInt:ADLayoutTransition_DISAPPEARING])) {
    [self addToBufferedRunnablesWithJavaLangRunnable:new_ASIQPreviousNextViewImpl_$Lambda$1_initWithASIWidget_(widget)];
  }
  else {
...
J2OBJC_NAME_MAPPING(ASIQPreviousNextViewImpl, "com.ashera.iqkeyboardmanager", "AS")
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(initWithASIQPreviousNextViewImpl:);
  ...
  static const J2ObjcClassInfo _ASIQPreviousNextViewImpl_IQPreviousNextViewExt = { "IQPreviousNextViewExt", "com.ashera.iqkeyboardmanager", ptrTable, methods, fields, 7, 0x1, 38, 7, 3, -1, -1, -1, -1 };
...
void ASIQPreviousNextViewImpl_$Lambda$1_initWithASIWidget_(ASIQPreviousNextViewImpl_$Lambda$1 *self, id<ASIWidget> capture$0) {
  self->val$widget_ = capture$0;
  NSObject_init(self);
}

ASIQPreviousNextViewImpl_$Lambda$1 *new_ASIQPreviousNextViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_NEW_IMPL(ASIQPreviousNextViewImpl_$Lambda$1, initWithASIWidget_, capture$0)
}

ASIQPreviousNextViewImpl_$Lambda$1 *create_ASIQPreviousNextViewImpl_$Lambda$1_initWithASIWidget_(id<ASIWidget> capture$0) {
  J2OBJC_CREATE_IMPL(ASIQPreviousNextViewImpl_$Lambda$1, initWithASIWidget_, capture$0)
}
